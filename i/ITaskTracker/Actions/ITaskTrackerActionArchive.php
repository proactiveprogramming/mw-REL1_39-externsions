...
/**
 * ITaskTrackerActionArchive class.
 *
 */
class ITaskTrackerActionArchive extends ITaskTrackerAction
{
	/**
	 * Initialize class.
	 * 
	 ...
	 * @return void 
	 */
	public function archiveIbugAction()
	{
		...
		$this->getIbugModel('default')->archiveIbugIssue($issueId);
