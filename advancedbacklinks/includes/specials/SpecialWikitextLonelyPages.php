 ...
 * @ingroup SpecialPage
 */
class SpecialWikitextLonelyPages extends PageQueryPage {
	function __construct( $name = 'WikitextLonelyPages' ) {
		parent::__construct( $name );
		$this->addHelpLink( 'Extension:AdvancedBacklinks' );
	}

	function getPageHeader() {
		return $this->msg( 'advancedBacklinks-lonelypagestext' )->parseAsBlock();
	}
