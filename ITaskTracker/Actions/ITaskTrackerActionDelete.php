...
/**
 * ITaskTrackerActionDelete class.
 *
 */
class ITaskTrackerActionDelete extends ITaskTrackerAction
{
        /**
         * Initialize class.
         *
         ...
         * @return void
         */
        public function deleteIbugAction()
        {
                ...
                $this->getIbugModel('default')->deleteIbugIssue($issueId);
