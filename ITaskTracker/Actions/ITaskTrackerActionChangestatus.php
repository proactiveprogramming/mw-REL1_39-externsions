...
/**
 * IssueTrackerActionChangestatus class.
 */
class ITaskTrackerActionChangestatus extends ITaskTrackerAction
{
	/**
	 * Initialize class.
	 * 
	 ...
	 * @return void 
	 */
	public function changestatusIbugAction()
	{
		...
		$newstatus = $wgRequest->getText('bt_nstatus');
		$this->getIbugModel('default')->changestatusIbugIssue($issueId,$newstatus);
